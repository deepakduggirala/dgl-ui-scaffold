<template>
  <div class="Footer">
    <footer class="institution-footer" id="footer-v1" role="contentinfo" itemScope="itemscope"
      itemType="http://schema.org/CollegeOrUniversity">
      <v-container>
        <v-row>
          <v-col cols="12" lg="2"></v-col>
          <v-col cols="12" lg="3" class="signature text-center text-lg-left">
            <a href="https://www.iu.edu" class="signature-link signature-img external">
              <img src="src/assets/iu-sig.2x.png" width="236" height="36" alt="Indiana University" />
            </a>
          </v-col>
          ...
          <v-col cols="12" lg="7" class="text-center text-lg-right">
            <p class="copyright">
              <span class="line-break">
                <a id="accessibility-link" href="https://accessibility.iu.edu/assistance"
